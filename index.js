...
*/
reviews.push({name:'Brit', rating: 5, feedback: 'this place is great! Delicioius foods, awesome atmosphere, would recommend!'});
...
*/
reviews[7],feedback = 'this place is awesome with really cool people, great for dropping in on weekdays';
...
function getReviewByIndex(array, number) {
  return `${array[number].name} gave the restaurant a ${array[number].rating} star review, and their feedback
  was: ${array[number].feedback}`;
}
...
function getLastReview(array){
  return `${array[array.length -1].name} gave the restaurant a ${array[array.length -1].rating} star review
   and their feedback was: ${array[array.length -1].feedback}`;
} 
